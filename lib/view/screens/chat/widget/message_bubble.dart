...
import 'package:efood_multivendor_driver/data/model/response/message_model.dart';
...
import 'package:efood_multivendor_driver/view/screens/chat/widget/image_diaglog.dart';
...
class MessageBubble extends StatelessWidget {
  ...
  const MessageBubble({Key key,  this.message,  this.user,  this.userType,  this.sender}) : super(key: key);
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          ClipRRect(
            child: CustomImage(
              ...
              image: '${userType == UserType.vendor ? _baseUrl.restaurantImageUrl : _baseUrl.customerImageUrl}/${user.image ?? ''}',
            ),

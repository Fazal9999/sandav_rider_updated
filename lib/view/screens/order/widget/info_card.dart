...
class InfoCard extends StatelessWidget {
  ...
  InfoCard({ this.title,  this.image,  this.name,  this.addressModel,  this.phone,
     this.latitude,  this.longitude,  this.showButton, this.isDelivery = false, this.orderModel, this.messageOnTap});

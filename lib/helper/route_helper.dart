...
class RouteHelper {
  ...
  static String getChatRoute({ NotificationBody notificationBody, User user, int conversationId}) {
    ...
    return '$chatScreen?notification_body=$_notificationBody&user=$_user&conversation_id=$conversationId';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: chatScreen, page: () {
      ...
      return ChatScreen(
        notificationBody : _notificationBody, user: _user,
